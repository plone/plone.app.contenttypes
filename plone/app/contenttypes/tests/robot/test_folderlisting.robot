...
Listing should list contained content in detail
  ...
  Page Should Contain Element  xpath://img[@title="Test News Item"]  limit=2
  Page Should Contain  Test Event
  ...
  Page Should Contain  Test Image
  Page Should Contain Element  xpath://img[@title="Test Image"]  limit=3
  Page Should Contain  Test Album
  Page Should Contain  Test Album Image 1
  Page Should Contain Element  xpath://img[@title="Test Album Image 1"]  limit=2
  Page Should Contain  Test Album Image 2
  Page Should Contain Element  xpath://img[@title="Test Album Image 2"]  limit=2
  Page Should Contain  Test Album Image 3
  Page Should Contain Element  xpath://img[@title="Test Album Image 3"]  limit=2
  Page Should Contain  Test Sub Album
  Page Should Contain  Test Sub Album Image 1
  Page Should Contain Element  xpath://img[@title="Test Sub Album Image 1"]  limit=1
  Page Should Contain  Test Sub Album Image 2
  Page Should Contain Element  xpath://img[@title="Test Sub Album Image 2"]  limit=1
  Page Should Contain  Test Sub Album Image 3
  Page Should Contain Element  xpath://img[@title="Test Sub Album Image 3"]  limit=1
...
Listing should list all content in detail
  ...
  Page Should Contain  Test Sub Album
  Page Should Contain  Test Sub Album Image 1
  Page Should Contain Element  xpath://img[@title="Test Sub Album Image 1"]  limit=2
  Page Should Contain  Test Sub Album Image 2
  Page Should Contain Element  xpath://img[@title="Test Sub Album Image 2"]  limit=2
  Page Should Contain  Test Sub Album Image 3
  Page Should Contain Element  xpath://img[@title="Test Sub Album Image 3"]  limit=2

Album should list all images and albums
  Page Should Contain  Test Image
  Page Should Contain Element  xpath://div[@class="photoAlbumEntry" and not(@class="photoAlbumFolder")]//img[@title="Test Image"]  limit=1
  Page Should Contain  Test News Item
  Page Should Contain Element  xpath://div[@class="photoAlbumEntry" and not(@class="photoAlbumFolder")]//img[@title="Test News Item"]  limit=1
  Page Should Contain  Test Album Image 1
  Page Should Contain Element  xpath://div[@class="photoAlbumEntry" and not(@class="photoAlbumFolder")]//img[@title="Test Album Image 1"]  limit=1
  Page Should Contain  Test Album Image 2
  Page Should Contain Element  xpath://div[@class="photoAlbumEntry" and not(@class="photoAlbumFolder")]//img[@title="Test Album Image 2"]  limit=1
  Page Should Contain  Test Album Image 3
  Page Should Contain Element  xpath://div[@class="photoAlbumEntry" and not(@class="photoAlbumFolder")]//img[@title="Test Album Image 3"]  limit=1
  Page Should Contain  Test Sub Album Image 1
  Page Should Contain Element  xpath://div[@class="photoAlbumEntry" and not(@class="photoAlbumFolder")]//img[@title="Test Sub Album Image 1"]  limit=1
  Page Should Contain  Test Sub Album Image 2
  Page Should Contain Element  xpath://div[@class="photoAlbumEntry" and not(@class="photoAlbumFolder")]//img[@title="Test Sub Album Image 2"]  limit=1
  Page Should Contain  Test Sub Album Image 3
  Page Should Contain Element  xpath://div[@class="photoAlbumEntry" and not(@class="photoAlbumFolder")]//img[@title="Test Sub Album Image 3"]  limit=1
  Page Should Contain  Test Album
  Page Should Contain  Test Sub Album
